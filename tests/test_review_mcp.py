...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("orchestrator_review", "checkpoint is advisory"),
        ("orchestrator_review", "cannot prove which human"),
        ("orchestrator_review_run", "never shown to any reviewer"),
        ("orchestrator_review_run", "checkpoint is advisory"),
        ("orchestrator_review_run", "cannot prove which human"),
